...
Private Sub Form_Load()
    TextX.Text = Documents(MainForm.ActiveForm.DocumentIndex).OffsetX
    TextY.Text = Documents(MainForm.ActiveForm.DocumentIndex).OffsetY
End Sub

Private Sub CommandOK_Click()
    On Error GoTo ErrorHandle
    Documents(MainForm.ActiveForm.DocumentIndex).OffsetX = TextX.Text
    Documents(MainForm.ActiveForm.DocumentIndex).OffsetY = TextY.Text
